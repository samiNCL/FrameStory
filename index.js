...
function login(email, password) {
    ...
    fetch("https://165.232.43.182/api/login", {
        method: "POST",
...
function validateToken(authToken) {
    return fetch("https://165.232.43.182/api/validate-token", {
        method: "GET",
        headers: {
...
function loadTags(authToken) {
    fetch("https://165.232.43.182/api/tags", {
        method: "GET",
        headers: {
            "Authorization": `Bearer ${authToken}`,
            "Content-Type": "application/json"
...
function fetchReflectionsForVideo(videoUrl) {
    ...
    fetch(`https://165.232.43.182/api/resources?video_url=${encodeURIComponent(videoUrl)}`, {
        method: "GET",
        headers: {
...
function sendReflections() {
    ...
    fetch("https://165.232.43.182/api/resources", {
        method: "POST",
        headers: {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json"
...
function handleInvalidToken() {
    ...
    document.getElementById('add-reflection').style.display = 'none';
    ...
    document.getElementById('send-reflections').style.display = 'none';
}
...
if (storedToken) {
    // Show loading feedback
    showLoadingMessage("Checking authentication...");
